    ...
    <main className="justify-center items-center p-5 flex flex-col">
        ...
        <div className="shadow-lg rounded-lg relative justify-items-center w-4/5">
            ...
            <div className="flex flex-col p-5 space-y-2">
                ...
                (<HistoryBlock UserType={session.user.type} oneT={reportItem.date} Doctor={reportItem.dentistId.objectId} Symptom={reportItem.prescribed_medication} Treatment={reportItem.treatment} Recommendation={reportItem.recommendations} Patient={reportItem.patientId.objectId}/>)
                )}
