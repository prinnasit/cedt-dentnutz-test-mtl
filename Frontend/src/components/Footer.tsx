        ...
        <footer className="bg-white">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 w-full md:w-1/3 text-black">
                        <h3 className="text-lg font-bold mb-4">
                            About Us
                        </h3>
                        <p className="text-sm leading-relaxed">
                            At our CUD Dentist Clinic, we're not just about
                            appointments – we're about relationships. Led by a
                            team of skilled and compassionate professionals, we
                            prioritize your comfort and well-being above all
                            else. From routine cleanings to advanced treatments,
                            our expertise ensures that every smile receives the
                            care it deserves. Step into our clinic, where
                            precision meets empathy, and let us redefine your
                            dental experience, one visit at a time
                        </p>
                    </div>
                ...
                <hr className="my-12 border-gray-200 sm:mx-auto  lg:my-14" />
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center ">
                        © 2023{" "}
                        <a
                            href="https://cedt-se-project-dentnutz-frontend.vercel.app/dentist"
                            className="hover:underline"
                        >
                            Dentnutz™
                        </a>
