...
export default function HistoryBlock({oneT,Doctor,Symptom,Treatment,Recommendation,Patient}:{oneT:string,Doctor:mongoose.Schema.Types.ObjectId,Symptom:string,Treatment:string,Recommendation:string,Patient:mongoose.Schema.Types.ObjectId}){
    return(
    <div className="rounded-lg shadow-md p-3 text-black relative">

        {(false)?null:<a href="/report/update">
